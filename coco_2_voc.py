...
src_base = os.path.join("oil", "annotations")
dst_base = os.path.join("darkflow-master", "darkflow-master", "voc_oil")
...
sets = {
    "trainval": os.path.join(src_base, "labels_coco.json"),
    # "test": os.path.join(src_base, "labels_coco.json"),
}
