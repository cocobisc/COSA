...
class Configuration(Config):
    ...
    NAME = "car"
    NUM_CLASSES = 3 # Background + Class Name
    IMAGES_PER_GPU = 1
    STEPS_PER_EPOCH = 100
    VALIDATION_STEPS = 50
    LEARNING_RATE = 0.001
...
def train(model):
    ...
    # Since we're using a very small data set, and starting from
...
def color_splash(image, mask):
    ...
    # Make a gray scale copy of the image. The gray scale copy still has 3 RGB channels, though.
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect cars and wheels.')
